<div>
    <div class="pomysl-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
            ...
            <div class="mt-8">
                @if ($hasVoted)
                    <button
                        ...
                        class="w-20 bg-red-700 border border-red-700 hover:border-red-800 font-bold text-xxs text-white uppercase rounded-xl transition duration-150 ease-in px-4 py-3"
                    >
                        Tak!
                    </button>
                @else
